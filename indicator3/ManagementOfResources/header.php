    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Menu 1 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="hri.php"><i class="fa fa-plus"></i>HR Inventory</a></li>
            <li><a href="fri.php"><i class="fa fa-plus"></i>FR Inventory</a></li>
            <li><a href="tri.php"><i class="fa fa-plus"></i>Tech. Resource Inventory</a></li>
            <li><a href="mri.php"><i class="fa fa-plus"></i>MR Inventory</a></li>
            <li><a href="ri.php"><i class="fa fa-plus"></i>M&E for Resource Inventory</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="hrdp.php"><i class="fa fa-plus"></i>HR Dev. Plan</a></li>
              <li><a href="fmdp.php"><i class="fa fa-plus"></i>Financial Mngt. Dev Plan</a></li>
                <li><a href="trip.php"><i class="fa fa-plus"></i>TR Improvement Plan</a></li>
                  <li><a href="spdp.php"><i class="fa fa-plus"></i>SP Dev. Plan</a></li>
          </ul>
        </li>
        <!-- Menu 3 -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="merm.php"><i class="fa fa-plus"></i>M&E Resource Mngt.</a></li>
            <li><a href="rmer.php"><i class="fa fa-plus"></i>Reporting of M&E Results</a></li>
            <li><a href="qs.php"><i class="fa fa-plus"></i>QA for SMEPA</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="isnm.php"><i class="fa fa-plus"></i>IS Net. Mechanism</a></li>
            <li><a href="esnm.php"><i class="fa fa-plus"></i>ESN Mechanism</a></li>
            <li><a href="men.php"><i class="fa fa-plus"></i>M&E for NSP</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="memo.php"><i class="fa fa-plus"></i>Memoranda</a></li>
            <li><a href="il.php"><i class="fa fa-plus"></i>Invitation Letters</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="sr.php"><i class="fa fa-plus"></i>SMEPA Reports</a></li>
            <li><a href="rsm.php"><i class="fa fa-plus"></i>Records of Sched. Meetings</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="osa.php"><i class="fa fa-plus"></i>OSA Reports</a></li>
          </ul>
        </li>
