...
if(isset($_POST['ind3_hri']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/HumanResourceInventory/' . $filename;
...
if(isset($_POST['ind3_fri']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/FinancialResourceInventory/' . $filename;
...
if(isset($_POST['ind3_tri']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/TechResourceInventory/' . $filename;
...
if(isset($_POST['ind3_mri']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/MaterialResourceInventory/' . $filename;
...
if(isset($_POST['ind3_ri']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/MEforResourceInventory/' . $filename;
...
if(isset($_POST['ind3_hrdp']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/HumanResourceDevPlan/' . $filename;
...
if(isset($_POST['ind3_fmdp']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/FinancialManagementDevPlan/' . $filename;
...
if(isset($_POST['ind3_trip']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/TechResourceImprovementPlan/' . $filename;
...
if(isset($_POST['ind3_spdp']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/SchoolPhysicalDevPlan/' . $filename;
...
if(isset($_POST['ind3_merm']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/MEofResourceManagement/' . $filename;
...
if(isset($_POST['ind3_rmer']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/ReportingMEResults/' . $filename;
...
if(isset($_POST['ind3_qs']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/QAforSMEPA/' . $filename;
...
if(isset($_POST['ind3_isnm']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/InternalStakeholdersNetMechanism/' . $filename;
...
if(isset($_POST['ind3_esnm']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/ExternalStakeholdersNetMechanism/' . $filename;
...
if(isset($_POST['ind3_men']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/MEforNSP/' . $filename;
...
if(isset($_POST['ind3_memo']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/Memoranda/' . $filename;
...
if(isset($_POST['ind3_il']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/InvitationLetters/' . $filename;
...
if(isset($_POST['ind3_ar']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/AttendanceRecords/' . $filename;
...
if(isset($_POST['ind3_pic']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/Pictures/' . $filename;
...
if(isset($_POST['ind3_mom']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/MinutesOfMeeting/' . $filename;
...
if(isset($_POST['ind3_sr']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/SMEPAReports/' . $filename;
...
if(isset($_POST['ind3_rsm']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/RecordsSchedMeetings/' . $filename;
...
if(isset($_POST['ind3_osa']))
{
	...
	$destination = '../ManagementOfResources/ind3_uploads/OSAReports/' . $filename;
