...
<h2>Reporting of M&E Results</h2>
<hr>
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body form-group form-group-sm">
				...
				<form action="rmer.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind3_rmer" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
			...
			<div class="panel-heading">
				<p><a href="../../indicator-3-list.php"> < back </a>|<a href="rmer.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div id="delete_file_ind3_rmer" class="modal fade">
