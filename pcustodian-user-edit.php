...
// the query
$query = "SELECT * FROM pcustodian_users WHERE id = '" . $mysqli->real_escape_string($getID) . "'";
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4> (Property Custodian) Editing User (<?php echo $getID; ?>)</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="update_user">
					<input type="hidden" name="action" value="update_user_pc">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_update_pcustodian" class="btn btn-success float-right" value="Edit user" data-loading-text="Editing...">
						</div>
					</div>
				</form>
			</div>
			<div class="panel-heading">
				<p><a href="pcustodian-user-list.php">< back </a></p>
			</div>
		</div>
	</div>
<div>
