	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Add Property Custodian User</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_user">
					<input type="hidden" name="action" value="pcustodian_user">
			...
			<div class="panel-heading">
				<p><a href="pcustodian-user-list.php">< back </a>| <a href="pcustodian-user-add.php"> refresh </a></p>
			</div>
		</div>
	</div>
