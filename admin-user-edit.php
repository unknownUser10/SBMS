...
// the query
$query = "SELECT * FROM admin_users WHERE id = '" . $mysqli->real_escape_string($getID) . "'";
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>(Administrator) Editing User (<?php echo $getID; ?>)</h4>
			</div>
				...
				<form method="post" id="update_user">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_update_admin" class="btn btn-success float-right" value="Edit user" data-loading-text="Editing...">
						</div>
					</div>
				</form>
			</div>
			<div class="panel-heading">
				<p><a href="admin-user-list.php">< back </a></p>
