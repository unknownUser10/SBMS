...
// the query
$query = "SELECT * FROM ind1_users WHERE id = '" . $mysqli->real_escape_string($getID) . "'";
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>(Indicator 1) Editing User (<?php echo $getID; ?>)</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="update_user">
					<input type="hidden" name="action" value="update_user_ind1">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_update_ind1" class="btn btn-success float-right" value="Edit user" data-loading-text="Editing...">
						</div>
					</div>
				</form>
			</div>
			<div class="panel-heading">
				<p><a href="ind1-user-list.php">< back </a></p>
