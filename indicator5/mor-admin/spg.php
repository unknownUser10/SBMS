...
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-default">
				...
				<form action="spg.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind5_spg" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
			...
			<div class="panel-heading">
				<p><a href="../../indicator-5-list.php"> < back </a>|<a href="spg.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div id="delete_file_ind5_spg" class="modal fade">
