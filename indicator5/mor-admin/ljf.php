	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body form-group form-group-sm">
				...
				<form action="ljf.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind5_ljf" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
			...
			<div class="panel-heading">
				<p><a href="../../indicator-5-list.php"> < back </a>|<a href="ljf.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div id="delete_file_ind5_ljf" class="modal fade">
