	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 style="color:#337ab7;">Add Indicator 5 User</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_user">
					<input type="hidden" name="action" value="ind5_user">
			...
			<div class="panel-heading">
				<p><a href="ind5-user-list.php">< back </a>| <a href="ind5-user-add.php"> refresh </a></p>
			</div>
		</div>
	</div>
