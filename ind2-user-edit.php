...
// the query
$query = "SELECT * FROM ind2_users WHERE id = '" . $mysqli->real_escape_string($getID) . "'";
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>(Indicator 2) Editing User (<?php echo $getID; ?>)</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="update_user">
					<input type="hidden" name="action" value="update_user_ind2">
			...
			<div class="panel-heading">
				<p><a href="ind2-user-list.php">< back </a></p>
