...
if(isset($_POST['ind5_jf']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/JollibeeFoundation/' . $filename;
...
if(isset($_POST['ind5_ljf']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/LoveJanFoundation/' . $filename;
...
if(isset($_POST['ind5_ds']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/DOLEStanfilco/' . $filename;
...
if(isset($_POST['ind5_edc']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/EDC/' . $filename;
...
if(isset($_POST['ind5_ppo']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/Others4ProjectPartners/' . $filename;
...
if(isset($_POST['ind5_pta']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/PTA/' . $filename;
...
if(isset($_POST['ind5_sgc']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/SGC/' . $filename;
...
if(isset($_POST['ind5_lgu']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/LGU/' . $filename;
...
if(isset($_POST['ind5_abc']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/ABC/' . $filename;
...
if(isset($_POST['ind5_aa']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/AlumniAssociation/' . $filename;
...
if(isset($_POST['ind5_fa']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/FacultyAssociation/' . $filename;
...
if(isset($_POST['ind5_spg']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/SPG-SSG/' . $filename;
...
if(isset($_POST['ind5_po']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/PrivateOrganization/' . $filename;
...
if(isset($_POST['ind5_rmpo']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/Others4RMP/' . $filename;
...
if(isset($_POST['ind5_aip']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/AIP-SIP/' . $filename;
...
if(isset($_POST['ind5_ppbm']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/ProjectProposal&BudgetMatrix/' . $filename;
...
if(isset($_POST['ind5_tad']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/TrainingActivityDesigns/' . $filename;
...
if(isset($_POST['ind5_pw']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/ProgramOfWorks/' . $filename;
...
if(isset($_POST['ind5_pic']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/Pictures/' . $filename;
...
if(isset($_POST['ind5_rmec']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/RecordsMEConducted/' . $filename;
...
if(isset($_POST['ind5_rrr']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/RegularReportingRecords/' . $filename;
...
if(isset($_POST['ind5_ar']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/AccomplishmentReports/' . $filename;
...
if(isset($_POST['ind5_mm']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/MinutesOfMeetings/' . $filename;
...
if(isset($_POST['ind5_arec']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/AttendanceRecords/' . $filename;
...
if(isset($_POST['ind5_osao']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/Others4OSA/' . $filename;
...
if(isset($_POST['ind5_mmc']))
{
	...
	$destination = '../../indicator5/ManagementOfResources/ind5_uploads/CopiesOfMOA&MOVs/' . $filename;
