...
if(isset($_POST['ind2_ifsrm']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/InternalFactorsAffectingSRM/' . $filename;
...
if(isset($_POST['ind2_ga']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/GAPAnalysis/' . $filename;
...
if(isset($_POST['ind2_ra']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/RapidAppraisal/' . $filename;
...
if(isset($_POST['ind2_fgdr']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/FGDResource/' . $filename;
...
if(isset($_POST['ind2_roap']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/ResultsOtherAnalysisProcess/' . $filename;
...
if(isset($_POST['ind2_ps']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/PlanningSched/' . $filename;
...
if(isset($_POST['ind2_dpm']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/DocumentsOfPlanningMeeting/' . $filename;
...
if(isset($_POST['ind2_sp']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/SupplementalPlan/' . $filename;
...
if(isset($_POST['ind2_ar']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/AttendanceRecord/' . $filename;
...
if(isset($_POST['ind2_sa']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/SupportingArtifacts/' . $filename;
...
if(isset($_POST['ind2_hrdp']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/HRDP-SPPD/' . $filename;
...
if(isset($_POST['ind2_fm']))
{
	...
	$destination = '../../indicator2/ManagementOfResources/ind2_uploads/FeedbackMechanism/' . $filename;
