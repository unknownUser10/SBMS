  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Menu 0.1 -->
        <li class="treeview">
          <a href="../sbms-co-admin.php"><i class="fa fa-tachometer"></i> <span>Dashboard</span>
          </a> 
        </li>

         <li class="treeview">
          <a href="../indicator1.php"><i class="fa fa-list"></i> <span>Indicator 1</span>
          </a> 
        </li>
        

         <li class="treeview">
          <a href="../indicator2.php"><i class="fa fa-list"></i> <span>Indicator 2</span>
          </a> 
        </li>
        

         <li class="treeview">
          <a href="../indicator3.php"><i class="fa fa-list"></i> <span>Indicator 3</span>
          </a> 
        </li>
        

         <li class="treeview">
          <a href="../indicator4.php"><i class="fa fa-list"></i> <span>Indicator 4</span>
          </a> 
        </li>
        

         <li class="treeview">
          <a href="../indicator5.php"><i class="fa fa-list"></i> <span>Indicator 5</span>
          </a> 
        </li>
