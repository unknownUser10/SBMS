...
if(isset($_POST['ind4_hrdp']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/HumanResourceDevPlan/' . $filename;
...
if(isset($_POST['ind4_frmdp']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/FinancialResourceManagementDevPlan/' . $filename;
...
if(isset($_POST['ind4_trip']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/TechResourceImprovementPlan/' . $filename;
...
if(isset($_POST['ind4_spfdp']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/SchoolPhysicalFacilitiesDevPlan/' . $filename;
...
if(isset($_POST['ind4_qaqp']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/QAforAQP/' . $filename;
...
if(isset($_POST['ind4_sm']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/StartUpMonitoring/' . $filename;
...
if(isset($_POST['ind4_qpm']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/QuarterlyProgressMonitoring/' . $filename;
...
if(isset($_POST['ind4_ige']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/InitialGainEvaluation/' . $filename;
...
if(isset($_POST['ind4_qapm']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/QA4ProgressMonitoring/' . $filename;
...
if(isset($_POST['ind4_oe']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/OutcomeEvaluation/' . $filename;
...
if(isset($_POST['ind4_im']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/ImpactEvaluation/' . $filename;
...
if(isset($_POST['ind4_qmep']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/QA4MEP/' . $filename;
...
if(isset($_POST['ind4_sfa']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/StakeholdersForum/' . $filename;
...
if(isset($_POST['ind4_es']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/EducationSummit/' . $filename;
...
if(isset($_POST['ind4_others']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/Others/' . $filename;
...
if(isset($_POST['ind4_qrfb']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/QA4ReportingFeedbacking/' . $filename;
...
if(isset($_POST['ind4_ild']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/InvitationLetters/' . $filename;
...
if(isset($_POST['ind4_prog']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/Programs/' . $filename;
...
if(isset($_POST['ind4_st']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/SynthesisTemplates/' . $filename;
...
if(isset($_POST['ind4_tam']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/Templates4AgreementsMade/' . $filename;
...
if(isset($_POST['ind4_srm']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/ScheduleofRegularMeetings/' . $filename;
...
if(isset($_POST['ind4_ar']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/AttendanceRecords/' . $filename;
...
if(isset($_POST['ind4_mom']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/MinutesOfTheMeeting/' . $filename;
...
if(isset($_POST['ind4_vip']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/Validation&InventoryOfPrograms/' . $filename;
...
if(isset($_POST['ind4_pic']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/Pictures/' . $filename;
...
if(isset($_POST['ind4_nr']))
{
	...
	$destination = '../../indicator4/ManagementOfResources/ind4_uploads/NarrativeReports/' . $filename;
