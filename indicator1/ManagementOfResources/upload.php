...
if(isset($_POST['ind1_hr']))
{
	...
	$destination = 'ind1_uploads/HumanResources/' . $filename;
...
if(isset($_POST['ind1_fr']))
{
	...
	$destination = 'ind1_uploads/FinancialResources/' . $filename;
...
if(isset($_POST['ind1_tr']))
{
	...
	$destination = 'ind1_uploads/TechResources/' . $filename;
...
if(isset($_POST['ind1_mr']))
{
	...
	$destination = 'ind1_uploads/MaterialResources/' . $filename;
...
if(isset($_POST['ind1_fgds']))
{
	...
	$destination = 'ind1_uploads/FGDwithStakeholders/' . $filename;
...
if(isset($_POST['ind1_rsp']))
{
	...
	$destination = 'ind1_uploads/ResourceStrategicPlan/' . $filename;
...
if(isset($_POST['ind1_mqi']))
{
	...
	$destination = 'ind1_uploads/MonthlyQuarterlyInventory/' . $filename;
...
if(isset($_POST['ind1_ptb']))
{
	...
	$destination = 'ind1_uploads/PostingofTrasparencyBoard/' . $filename;
...
if(isset($_POST['ind1_rmooe']))
{
	...
	$destination = 'ind1_uploads/ReportsMOOEUtilization/' . $filename;
...
if(isset($_POST['ind1_rsefu']))
{
	...
	$destination = 'ind1_uploads/ReportsonSEFUtilization/' . $filename;
...
if(isset($_POST['ind1_rigp']))
{
	...
	$destination = 'ind1_uploads/ReportsonIGP/' . $filename;
...
if(isset($_POST['ind1_mcc']))
{
	...
	$destination = 'ind1_uploads/MeteeingsConferencesConsultations/' . $filename;
...
if(isset($_POST['ind1_fgdsori']))
{
	...
	$destination = 'ind1_uploads/FGDbyStakeholders&SORI/' . $filename;
...
if(isset($_POST['ind1_rirdv']))
{
	...
	$destination = 'ind1_uploads/ReportsDulyValidated/' . $filename;
...
if(isset($_POST['ind1_sipaip']))
{
	...
	$destination = 'ind1_uploads/SIP-AIP/' . $filename;
...
if(isset($_POST['ind1_lr']))
{
	...
	$destination = 'ind1_uploads/LiquidationReports/' . $filename;
...
if(isset($_POST['ind1_nr']))
{
	...
	$destination = 'ind1_uploads/NarrativeReports/' . $filename;
...
if(isset($_POST['ind1_osa']))
{
	...
	$destination = 'ind1_uploads/OtherSupportingArtifacts/' . $filename;
