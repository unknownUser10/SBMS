				...
				<form action="nr.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind1_nr" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
					</div>
				</form>
			</div>
			<div class="panel-heading">
				<p><a href="../../indicator-1-list.php"> < back </a>|<a href="nr.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div id="delete_file_nr" class="modal fade">
