...
if(isset($_POST['ind1_hr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/HumanResources/' . $filename;
...
if(isset($_POST['ind1_fr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/FinancialResources/' . $filename;
...
if(isset($_POST['ind1_tr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/TechResources/' . $filename;
...
if(isset($_POST['ind1_mr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/MaterialResources/' . $filename;
...
if(isset($_POST['ind1_fgds']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/FGDwithStakeholders/' . $filename;
...
if(isset($_POST['ind1_rsp']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/ResourceStrategicPlan/' . $filename;
...
if(isset($_POST['ind1_mqi']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/MonthlyQuarterlyInventory/' . $filename;
...
if(isset($_POST['ind1_ptb']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/PostingofTrasparencyBoard/' . $filename;
...
if(isset($_POST['ind1_rmooe']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/ReportsMOOEUtilization/' . $filename;
...
if(isset($_POST['ind1_rsefu']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/ReportsonSEFUtilization/' . $filename;
...
if(isset($_POST['ind1_rigp']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/ReportsonIGP/' . $filename;
...
if(isset($_POST['ind1_mcc']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/MeteeingsConferencesConsultations/' . $filename;
...
if(isset($_POST['ind1_fgdsori']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/FGDbyStakeholders&SORI/' . $filename;
...
if(isset($_POST['ind1_rirdv']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/ReportsDulyValidated/' . $filename;
...
if(isset($_POST['ind1_sipaip']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/SIP-AIP/' . $filename;
...
if(isset($_POST['ind1_lr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/LiquidationReports/' . $filename;
...
if(isset($_POST['ind1_nr']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/NarrativeReports/' . $filename;
...
if(isset($_POST['ind1_osa']))
{
	...
	$destination = '../ManagementOfResources/ind1_uploads/OtherSupportingArtifacts/' . $filename;
