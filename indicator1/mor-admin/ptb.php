...
<h2>Posting of Transparency Board</h2>
<hr>
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			...
			<div class="panel-body form-group form-group-sm">
				...
				<form action="ptb.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind1_ptb" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
					</div>
				</form>
			</div>
			<div class="panel-heading">
				<p><a href="../../indicator-1-list.php"> < back </a>|<a href="ptb.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div id="delete_file_ptb" class="modal fade">
