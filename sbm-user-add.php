...
<div id="response" class="alert alert-success" style="display:none;">
	...
	<!-- sbm coordinator add user -->

	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Add SBM Coordinator User</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_user">
					<input type="hidden" name="action" value="sbm_user">
			...
			<div class="panel-heading">
				<p><a href="sbm-user-list.php">< back </a>| <a href="sbm-user-add.php"> refresh </a></p>
			</div>
		</div>
	</div>
