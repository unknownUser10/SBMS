...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b >SBMS</b></span>
        ...
        <!-- Menu 1 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ifsrm.php"><i class="fa fa-plus"></i>Internal Factors Affecting SRM</a></li>
          </ul>
        </li>
        <!-- Menu 2 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ga.php"><i class="fa fa-plus"></i>GAP Analysis</a></li>
            <li><a href="ra.php"><i class="fa fa-plus"></i>Rapid Appraisal</a></li>
             <li><a href="fgdr.php"><i class="fa fa-plus"></i>FGD Resource</a></li>
            <li><a href="roap.php"><i class="fa fa-plus"></i>Results of Other AP</a></li>
          </ul>
        </li>
        <!-- Menu 3 -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ps.php"><i class="fa fa-plus"></i>Planning Schedule</a></li>
            <li><a href="dpm.php"><i class="fa fa-plus"></i>Min/Docs Of Planning Meeting</a></li>
             <li><a href="sp.php"><i class="fa fa-plus"></i>Supplemental Plan</a></li>
            <li><a href="ar.php"><i class="fa fa-plus"></i>Attendance Records</a></li>
            <li><a href="sa.php"><i class="fa fa-plus"></i>Supporting Artifacts</a></li>
            <li><a href="hrdp.php"><i class="fa fa-plus"></i>Human Resource Dev. Plan</a></li>
             <li><a href="fm.php"><i class="fa fa-plus"></i>Feedback Mechanism</a></li>
          </ul>
        </li>
