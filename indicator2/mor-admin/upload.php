...
if(isset($_POST['ind2_ifsrm']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/InternalFactorsAffectingSRM/' . $filename;
...
if(isset($_POST['ind2_ga']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/GAPAnalysis/' . $filename;
...
if(isset($_POST['ind2_ra']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/RapidAppraisal/' . $filename;
...
if(isset($_POST['ind2_fgdr']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/FGDResource/' . $filename;
...
if(isset($_POST['ind2_roap']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/ResultsOtherAnalysisProcess/' . $filename;
...
if(isset($_POST['ind2_ps']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/PlanningSched/' . $filename;
...
if(isset($_POST['ind2_dpm']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/DocumentsOfPlanningMeeting/' . $filename;
...
if(isset($_POST['ind2_sp']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/SupplementalPlan/' . $filename;
...
if(isset($_POST['ind2_ar']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/AttendanceRecord/' . $filename;
...
if(isset($_POST['ind2_sa']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/SupportingArtifacts/' . $filename;
...
if(isset($_POST['ind2_hrdp']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/HRDP-SPPD/' . $filename;
...
if(isset($_POST['ind2_fm']))
{
	...
	$destination = '../ManagementOfResources/ind2_uploads/FeedbackMechanism/' . $filename;
