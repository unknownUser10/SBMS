	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 style="color:#337ab7;">Add Indicator 4 User</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_user">
					<input type="hidden" name="action" value="ind4_user">
			...
			<div class="panel-heading">
				<p><a href="ind4-user-list.php">< back </a>| <a href="ind4-user-add.php"> refresh </a></p>
			</div>
		</div>
	</div>
