...
<h2>Technology Resource Improvement Plan</h2>
<hr>
...
<div class="row">
	<div class="col-xs-12">
		<div class="panel panel-default">
				...
				<form action="trip.php" method="post" enctype="multipart/form-data">
					...
					<div class="row">		
							...
							<div class="col-xs-12 margin-top btn-group">
									<button type="submit" name="ind4_trip" class="btn btn-success float-right" data-loading-text="Submitting...">Submit File</button>
							</div>
			...
			<div class="panel-heading">
				<p><a href="../../indicator-4-list.php"> < back </a>|<a href="trip.php"> refresh </a></p>
			</div>
		</div>
	</div>
</div>
...
<div>
<div id="delete_file_ind4_trip" class="modal fade">
